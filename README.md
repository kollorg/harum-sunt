...
[![addon-console](https://img.shields.io/npm/dt/@kollorg/harum-sunt.svg)](https://github.com/kollorg/harum-sunt)
...
[![storybook-addon-console](https://raw.githubusercontent.com/kollorg/harum-sunt/master/docs/storybook-addon-console.png)](https://raw.githubusercontent.com/kollorg/harum-sunt/master/docs/storybook-addon-console.png)
...
```shell
yarn add -D @kollorg/harum-sunt @storybook/addon-actions
```
...
import { setConsoleOptions } from '@kollorg/harum-sunt';
...
import { withConsole } from '@kollorg/harum-sunt';
...
## API
<a name="module_@kollorg/harum-sunt"></a>
...
* [@kollorg/harum-sunt](#module_@kollorg/harum-sunt)
    * _static_
        * [.setConsoleOptions(optionsOrFn)](#module_@kollorg/harum-sunt.setConsoleOptions) ⇒ <code>addonOptions</code>
        * [.withConsole([optionsOrFn])](#module_@kollorg/harum-sunt.withConsole) ⇒ <code>function</code>
    * _inner_
        * [~addonOptions](#module_@kollorg/harum-sunt..addonOptions) : <code>Object</code>
        * [~optionsCallback](#module_@kollorg/harum-sunt..optionsCallback) ⇒ <code>addonOptions</code>

<a name="module_@kollorg/harum-sunt.setConsoleOptions"></a>

### @kollorg/harum-sunt.setConsoleOptions(optionsOrFn) ⇒ <code>addonOptions</code>
Set addon options and returns a new one

**Kind**: static method of [<code>@kollorg/harum-sunt</code>](#module_@kollorg/harum-sunt)  
**See**
...
```
<a name="module_@kollorg/harum-sunt.withConsole"></a>

### @kollorg/harum-sunt.withConsole([optionsOrFn]) ⇒ <code>function</code>
...
```
<a name="module_@kollorg/harum-sunt..addonOptions"></a>

### @kollorg/harum-sunt~addonOptions : <code>Object</code>
This options could be passed to [withConsole](#storybookaddon-consolewithconsoleoptionsorfn--function) or [setConsoleOptions](#module_@kollorg/harum-sunt.setConsoleOptions)

**Kind**: inner typedef of [<code>@kollorg/harum-sunt</code>](#module_@kollorg/harum-sunt)  
**Properties**
...
<a name="module_@kollorg/harum-sunt..optionsCallback"></a>

### @kollorg/harum-sunt~optionsCallback ⇒ <code>addonOptions</code>
